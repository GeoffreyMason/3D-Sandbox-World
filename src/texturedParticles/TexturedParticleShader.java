...
public class TexturedParticleShader extends ShaderProgram {

	private static final String VERTEX_FILE = "src/texturedParticles/texParticleVShader.txt";
	private static final String FRAGMENT_FILE = "src/texturedParticles/texParticleFShader.txt";
	...
	protected void getAllUniformLocations() {
		...
		location_texOffset1 = super.getUniformLocation("textureOffset1");
		location_texOffset2 = super.getUniformLocation("textureOffset2");
