...
public class FlameThrowerParticleSystem {
	...
	public FlameThrowerParticleSystem(float pps, float speed, float gravityComplient, float lifeLength, float scale, Vector3f velocity) {
		this.pps = pps;
		this.speed = speed;
