...
public class PaintBeamParticleSystem {
	...
	public PaintBeamParticleSystem(Vector3f direction, float pps, float speed, float gravityComplient, float lifeLength, float scale) {
		this.pps = pps;
		this.speed = speed;
	...
	private void emitParticle(Vector3f centre, float spread, Loader loader, Chunk terrain) {
		...
		new PaintBeamParticle(new Vector3f(posX, centre.y, posZ), velocity, colour, gravityComplient, lifeLength, speed, 0, scale, false, loader);
	}
}
