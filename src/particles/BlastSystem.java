...
public class BlastSystem {
	...
	public BlastSystem(float pps, float speed, float gravityComplient, float lifeLength, float scale) {
		this.pps = pps;
		this.speed = speed;
	...
	private void emitParticle(Vector3f centre, float spread, Loader loader, Chunk terrain) {
		...
		new FireParticle(new Vector3f(posX, centre.y, posZ), velocity, gravityComplient, lifeLength, speed, 0, scale, false, loader);
	}
